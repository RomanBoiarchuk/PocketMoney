                ...
                JDialog dialog=new JDialog(Swing.frame,"Income",true){
                    {
                        ...
                        confirmButton.addActionListener(e->{
                            if (sourceField.getText().trim().equals("")){
                                ...
                                Swing.user.setIncomeSource(OperationsPanel.IToolbar.getComponentIndex(OperationsPanel.OperationsButtons.get(operation)), sourceField.getText());
                ...
                JDialog dialog=new JDialog(Swing.frame,"Income",true){
                    {
                        ...
                        confirmButton.addActionListener(e->{
                                    if (!accountBox.getSelectedItem().equals(((Income) operation).getAccount())) {
                                        ...
                                        Swing.user.setIncomeAccount(IToolbar.getComponentIndex(OperationsPanel.OperationsButtons.get(operation)), (String)accountBox.getSelectedItem());
                                        String line = operation.getDate() + "\n" + "from \"" + ((Income) operation).getSource() + "\" to \"" + ((Income) operation).getAccount() + "\": " + String.format("%.2f", operation.getSum()) + " UAH";
                                        OperationsPanel.OperationsButtons.get(operation).setText("<html>" + line.replaceAll("\\n", "<br>") + "</html>");
